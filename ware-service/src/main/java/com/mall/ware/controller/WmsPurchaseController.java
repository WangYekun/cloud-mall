...
import com.mall.ware.service.WmsPurchaseService;
 ...
 */
@RestController
@RequestMapping("product/wmspurchase")
public class WmsPurchaseController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("product:wmspurchase:list")
    ...
    // @RequiresPermissions("product:wmspurchase:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("product:wmspurchase:save")
    ...
    // @RequiresPermissions("product:wmspurchase:update")
    ...
    // @RequiresPermissions("product:wmspurchase:delete")
