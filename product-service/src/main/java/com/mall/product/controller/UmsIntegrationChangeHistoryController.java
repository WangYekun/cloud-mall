...
import com.mall.product.service.UmsIntegrationChangeHistoryService;
 ...
 */
@RestController
@RequestMapping("product/umsintegrationchangehistory")
public class UmsIntegrationChangeHistoryController {
     ...
     */
    @RequestMapping("/list")
    // @RequiresPermissions("product:umsintegrationchangehistory:list")
    ...
    // @RequiresPermissions("product:umsintegrationchangehistory:info")
     ...
     */
    @RequestMapping("/save")
    // @RequiresPermissions("product:umsintegrationchangehistory:save")
    ...
    // @RequiresPermissions("product:umsintegrationchangehistory:update")
    ...
    // @RequiresPermissions("product:umsintegrationchangehistory:delete")
